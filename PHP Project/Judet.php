...
include('functions.php');
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO judet (de, COD) 
            VALUES ('$den', '$COD1')";

    // Verificare dacă inserarea a fost realizată cu succes
    if (mysqli_query($con, $sql)) {
        echo "Judet adăugat cu succes!";
    } else {
...
<html>
    ...
    <a class="active" href="add_user.php"><i class="Contact">Adaugare Judetului
    </a>
...
<div id="box">
	<h2>Introduceti datele pentru a adauga un judet</h2> 
